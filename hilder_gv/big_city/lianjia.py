...
class Lianjia:
    ...
    def __init__(self):
        ...
        self.start_url = [
            ('https://sh.lianjia.com/xiaoqu/', '上海'),
            ('https://bj.lianjia.com/xiaoqu/', '北京'),
            ('https://gz.lianjia.com/xiaoqu/', '广州'),
            ('https://sz.lianjia.com/xiaoqu/', '深圳'),
            ('https://tj.lianjia.com/xiaoqu/', '天津'),
            ('https://wh.lianjia.com/xiaoqu/', '武汉'),
            ('https://dl.lianjia.com/xiaoqu/', '大连'),
            ('https://nj.lianjia.com/xiaoqu/', '南京'),
            ('https://sy.lianjia.com/xiaoqu/', '沈阳'),
            ('https://su.lianjia.com/xiaoqu/', '苏州'),
            ('https://qd.lianjia.com/xiaoqu/', '青岛'),
            ('https://cs.lianjia.com/xiaoqu/', '长沙'),
            ('https://cd.lianjia.com/xiaoqu/', '成都'),
            ('https://cq.lianjia.com/xiaoqu/', '重庆'),
            ('https://hz.lianjia.com/xiaoqu/', '杭州'),
            ('https://xm.lianjia.com/xiaoqu/', '厦门'),
            ('https://hf.lianjia.com/xiaoqu/', '合肥'),
        ]
