"""
生产者木有改变,列表中含有100个字典,使用前六台代理服务器,每一台最大并发量20,请求失败的时候切换一下IP
"""
...
class StreetConsume:
    def __init__(self,proxies):
        ...
        self.headers = {
            'Cookie': 'guid=7a2b-e4a0-254b-11c5; cna=i/YpFOjQczwCAWXgEAt5+FYJ; UM_distinctid=16619d4e2194f6-0ac3308713f79-3c7f0257-140000-16619d4e21a234; _uab_collina=153803167480376613790612; key=bfe31f4e0fb231d29e1d3ce951e2c780; _umdata=6AF5B463492A874DF795A3C884C44A15A9B62757D7DF25F615FB1B7B56E61350FFD51FFBFD2AF40CCD43AD3E795C914C469B2D819C14E24E2C8CD5819FBBD9C4; CNZZDATA1255626299=787519963-1538028684-https%253A%252F%252Fwww.baidu.com%252F%7C1539078853; x5sec=7b22617365727665723b32223a223764313032613032663263663930623961313764383937326263303566656434434a6143387430464549362f7a4f3363673565782f67453d227d; isg=BJ-fqCzOOOp8njzmoSYGlLkMLvrprPmsQwtAnjHsFM6VwL9COdUg9wWehhAb2Mse',
    ...
    def send_url(self, param):
        ...
        try:
            ...
            log.error(
                '请求失败，切换一下IP,url="https://www.amap.com/service/poiInfo?query_type=TQUERY&pagesize=30&pagenum=1&qii=true&cluster_state=5&need_utd=true&utd_sceneid=1000&div=PC1000&addr_poi_merge=true&is_classify=true&city={}&keywords={}"'.format(
