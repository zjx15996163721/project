...
#         print(count)
#         data = {
#             'finish_building_date': i.get('finish_building_date', None),
#             'estate_charge': i.get('estate_charge', None),
#             'household_count': i.get('household_count', None)
#         }
#         try:
#             es.index(index='city', doc_type='str', body=data)
#             print('导入一条数据到es{}'.format(data))
