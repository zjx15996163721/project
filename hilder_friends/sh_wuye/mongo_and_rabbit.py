...
class Monbbit():
    ...
    def __init__(self, db, coll, queue, *args, m_host='114.80.150.196', m_port=27777, r_host='192.168.0.190',
                 r_port=5673):
        self.db = db
        self.coll = coll
        self.queue = queue
    ...
    def connect_mongo(self):
        m = Mongo(self.m_host, self.m_port, user_name='goojia', password='goojia7102')
